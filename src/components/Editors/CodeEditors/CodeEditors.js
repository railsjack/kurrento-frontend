...
import {Card, CardBody, CardFooter, CardHeader, Form, FormGroup, Input} from 'reactstrap';
      ...
      <Card>
        <CardHeader>
          ...
          <div className="card-header-actions">
            <a href="https://github.com/scniro/react-codemirror2" rel="noopener noreferrer" target="_blank"
        ...
        <CardFooter>
          <Form inline>
            <FormGroup>
              <Input type="select" bsSize="sm" name="theme" id="theme" onChange={(e) => this.changeTheme(e)}
            ...
            <FormGroup>
              <Input type="select" bsSize="sm" name="mode" id="mode" onChange={(e) => this.changeMode(e)}
