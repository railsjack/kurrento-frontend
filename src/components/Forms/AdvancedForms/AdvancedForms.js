          ...
          <Col sm={12} md={6}>
            <Card>
              <CardHeader>
                ...
                <div className="card-header-actions">
                  <a href="https://github.com/JedWatson/react-select" rel="noreferrer noopener" target="_blank"
            ...
            <Card>
              <CardHeader>
                ...
                <a href="https://coreui.io/pro/react/" className="badge badge-danger">CoreUI Pro Component</a>
                <div className="card-header-actions">
                  <a href="https://github.com/airbnb/react-dates" rel="noreferrer noopener" target="_blank"
                     className="card-header-action">
                    <small className="text-muted">docs</small>
                  </a>
                </div>
