  ...
  render() {
    return (
      <div className="animated">
        <Card>
          <CardHeader>
            <i className="fa fa-spinner fa-spin"></i> Spinners - SpinKit{' '}
            <a href="https://coreui.io/pro/react/" className="badge badge-danger">CoreUI Pro Component</a>
            <div className="card-header-actions">
              <a href="https://github.com/tobiasahlin/SpinKit" rel="noopener noreferrer" target="_blank"
          ...
          <CardBody>
            <p>
              Simple loading spinners animated with CSS. SpinKit uses hardware accelerated (translate and opacity) CSS
