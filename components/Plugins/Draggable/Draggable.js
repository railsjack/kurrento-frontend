        ...
        <ResponsiveGridLayout className="layout" layouts={this.state.layouts}
          ...
          <Card key="a" className="card-accent-primary">
            <CardHeader>
              ...
              <div className="card-header-actions">
                <Button color="link" size="sm" className="card-header-action" onClick={() => this.resetLayout()}>Reset
                  Layout</Button>
              </div>
            </CardHeader>
            <CardBody>
          ...
          <Card key="b" className="card-accent-secondary">
            <CardHeader>
              ...
              Drag & Drop Card 2 <a href="https://coreui.io/pro/react/" className="badge badge-danger">CoreUI Pro
              Component</a>
            </CardHeader>
            <CardBody>
              {loremIpsum}
          ...
          <Card key="c" className="card-accent-success">
            <CardHeader>
              <i className="cui-cursor-move"></i>
              Drag & Drop Card 3 <a href="https://coreui.io/pro/react/" className="badge badge-danger">CoreUI Pro
              Component</a>
            </CardHeader>
            <CardBody>
              {loremIpsum}
          ...
          <Card key="d" className="card-accent-info">
            <CardHeader>
              <i className="cui-cursor-move"></i>
              Drag & Drop Card 4 <a href="https://coreui.io/pro/react/" className="badge badge-danger">CoreUI Pro
              Component</a>
            </CardHeader>
            <CardBody>
              {loremIpsum}
          ...
          <Card key="e" className="card-accent-warning">
            <CardHeader>
              <i className="cui-cursor-move"></i>
              Drag & Drop Card 5 <a href="https://coreui.io/pro/react/" className="badge badge-danger">CoreUI Pro
              Component</a>
            </CardHeader>
            <CardBody>
              {loremIpsum}
          ...
          <Card key="f" className="card-accent-danger">
            <CardHeader>
              <i className="cui-cursor-move"></i>
              Drag & Drop Card 6 <a href="https://coreui.io/pro/react/" className="badge badge-danger">CoreUI Pro
              Component</a>
            </CardHeader>
            <CardBody>
              {loremIpsum}
